...
if __name__ == "__main__":
    ...
    parser.add_argument("--video_dir", default="/home/axa230262/scratch/STTran/action_genome/videos",
                        help="Folder containing Charades videos.")
    parser.add_argument("--frame_dir", default="/home/axa230262/scratch/STTran/action_genome/frames",
                        help="Root folder containing frames to be dumped.")
    parser.add_argument("--annotation_dir", default="/home/axa230262/scratch/STTran/action_genome/annotations",
